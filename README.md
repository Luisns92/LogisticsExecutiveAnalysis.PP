...
.   
### 🎯 Objetivo:  
 El objetivo principal es identificar los clientes y rutas con mayor generación de ingresos durante los años 2022, 2023 y 2024.

### ❌ Problema:  
 La empresa cuenta con un gran volumen de información operativa distribuida en diferentes tablas, lo que dificulta identificar rápidamente qué clientes, conductores y rutas generan la mayor parte de los ingresos. La ausencia de indicadores consolidados limita el análisis del desempeño y retrasa la toma de decisiones estratégicas.

### ✅ Solución:  
 Se desarrolló un dashboard ejecutivo en Power BI respaldado por un modelo de datos tipo Star Schema, que consolida la información operativa en una única fuente de consulta. El dashboard permite analizar de forma interactiva los ingresos por año, cliente y ruta mediante KPIs, filtros dinámicos y visualizaciones diseñadas para facilitar la toma de decisiones.

### 🔢 Metodologia:  
  1. Limpieza y depuración del conjunto de datos utilizando Python (Pandas).
  2. Corrección de formatos, eliminación de inconsistencias y tratamiento de valores faltantes.
  3. Integración y enriquecimiento de los datos provenientes de múltiples tablas.
  4. Diseño e implementación de un modelo dimensional mediante Star Schema.
  5. Creación de una tabla calendario y establecimiento de relaciones entre tablas.
  6. Desarrollo de medidas e indicadores clave (KPIs) utilizando DAX.
